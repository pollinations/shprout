...
The page boots a disposable WebContainer, runs Polli through
`npx -y --package @pollinations_ai/cli@latest polli`,
...
`~/.pollinations/credentials.json` inside the WebContainer for the published
Polli CLI to read.
